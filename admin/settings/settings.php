...
<div class="addify-rfq-settings">
	<div class="wrap woocommerce">
		...
		<h2 class="nav-tab-wrapper">
			...
			<a href="?post_type=addify_quote&page=af-rfq-settings&tab=button" class="nav-tab <?php echo esc_attr( $active_tab ) === 'button' ? 'nav-tab-active' : ''; ?>"><?php echo esc_html__( 'Quote Buttons', 'addify_rfq' ); ?>
			</a>
		</h2>
	</div>
