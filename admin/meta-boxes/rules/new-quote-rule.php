	...
	<div class="afrfq_admin_main_right">
		...
		<div class="all_cats">
			<ul>
				...
				?>
					<li class="par_cat">
						<input type="checkbox" class="parent" name="afrfq_hide_user_role[]" id="" value="<?php echo esc_attr($key); ?>" <?php
				...
				<?php } ?>
				<li class="par_cat">
					<input type="checkbox" class="parent" name="afrfq_hide_user_role[]" id="" value="guest" <?php
	...
	<div class="afrfq_admin_main_right">
		...
		<div class="all_cats">
			<ul>
				...
				?>
					<li class="par_cat">
						<input type="checkbox" class="parent" name="afrfq_hide_categories[]" id="afrfq_hide_categories" value="<?php echo intval($parent_product_cat->term_id); ?>" <?php
						...
						?>
							<ul>
								<?php foreach ($child_product_cats as $child_product_cat) { ?>
									<li class="child_cat">
										<input type="checkbox" class="child parent" name="afrfq_hide_categories[]" id="afrfq_hide_categories" value="<?php echo intval($child_product_cat->term_id); ?>" <?php
										...
										?>
											...
											<ul>
												<?php foreach ($child_product_cats2 as $child_product_cat2) { ?>
													...
													<li class="child_cat">
														<input type="checkbox" class="child parent" name="afrfq_hide_categories[]" id="afrfq_hide_categories" value="<?php echo intval($child_product_cat2->term_id); ?>" <?php
														...
														?>
															...
															<ul>
																<?php foreach ($child_product_cats3 as $child_product_cat3) { ?>
																	...
																	<li class="child_cat">
																		<input type="checkbox" class="child parent" name="afrfq_hide_categories[]" id="afrfq_hide_categories" value="<?php echo intval($child_product_cat3->term_id); ?>" <?php
																		...
																		?>
																			...
																			<ul>
																				<?php foreach ($child_product_cats4 as $child_product_cat4) { ?>
																					...
																					<li class="child_cat">
																						<input type="checkbox" class="child parent" name="afrfq_hide_categories[]" id="afrfq_hide_categories" value="<?php echo intval($child_product_cat4->term_id); ?>" <?php
																						...
																						?>
																							...
																							<ul>
																								<?php foreach ($child_product_cats5 as $child_product_cat5) { ?>
																									...
																									<li class="child_cat">
																										<input type="checkbox" class="child parent" name="afrfq_hide_categories[]" id="afrfq_hide_categories" value="<?php echo intval($child_product_cat5->term_id); ?>" <?php
																										...
																										?>
																											...
																											<ul>
																												<?php foreach ($child_product_cats6 as $child_product_cat6) { ?>
																													...
																													<li class="child_cat">
																														<input type="checkbox" class="child" name="afrfq_hide_categories[]" id="afrfq_hide_categories" value="<?php echo intval($child_product_cat6->term_id); ?>" <?php
